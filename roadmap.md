...
- Active experiment: Round 8 is running as a fixed-label order-sensitive suffix-view diagnostic (`job 1238`) to test whether preserving late prompt-token order can beat the Round 6 anchor without changing labels.
